					...
					<div class="panel" style="border-top-color: #38b03f;">
						...
						<div class="panel-body table-responsive" id="people-panel-body">
							<form class="form-horizontal container">
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="form-group">
										...
										<div class="col-md-8 col-sm-6">
											<input type="text" class="form-control" id="role" value="${manager.userName}"
											readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="role" class="col-lg-2 col-md-2 col-sm-2">管理员名字</label>
										<div class="col-md-8 col-sm-6">
											<input type="text" class="form-control" id="role" value="${manager.nickName}"
											readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8 col-sm-6">
											<input type="text" class="form-control" id="role" value="${manager.creator}"
											readonly="readonly"	>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8 col-sm-6">
											<input type="text" class="form-control" id="role" value="${manager.createTime}"
											readonly="readonly"	>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="form-group">
										<label for="description" class="col-lg-2 col-md-2 col-sm-2">角色信息</label>
										<div class="input-group col-md-8 col-sm-6">
											<c:forEach items="${roles }" var="role">
												<button type="button" style="margin: 2px;" class="btn">${role.roleName }</button>&nbsp;
											</c:forEach>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<a href="<%=path %>/admin/manager/edit/${manager.id}" class="btn btn-primary"><i class="icon icon-edit"></i>编辑管理员</a>
