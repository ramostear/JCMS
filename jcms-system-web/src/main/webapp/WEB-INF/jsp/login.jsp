...
<body>
	...
	<div class="login_lay">
		...
		<div class="logins" style="top: 115.5px;">
			...
			<form class="fc" id="login-form" action="<%=path %>/console/manager/signin" method="post">
				<div class="box_div">
					<div class="promptInpt">
						<p class="promptTxt" style="display: block;">用户名</p>
					</div>
					<input class="user inptText login-email" name="userName" value="${userName}" type="text"/>
				</div>
				<div class="box_div">
					<div class="promptInpt">
						<p class="promptTxt" style="display: none;">密码</p>
					</div>
					<input class="pwd01 inptText login-pwd" name="password" value="${password}"
						type="password"/>
				</div>
				<div id="verify" class="code_img" style="height: 40px; margin-bottom: 10px;">
					<div class="fl" style="*width: 110px;">
						<div class="promptInpt" style="width: 60px;">
							<p class="promptTxt" style="width: 60px; left: -38px;">验证码</p>
						</div>
						<input class="verify" value="0" type="hidden"/> 
						<input class="verification-code inptText login-code" name="verifyCode" type="text" style="margin-bottom: 0; background: #eff3f6"/>
					</div>
					<a style="display: none;" class="verification-code-img fl vcode" href="Javascript: void(0);" onclick="changeImg()">
						<img id="ver_code" src="#"/>
					</a>
				</div>
			...
			<div class="states" style="margin: 0 auto; height: 24px;">
				<div class="stat">
					<label class="checkbox fl" style="margin-bottom: 0; margin-top: 5px;"> 
						7天内自动登录 
						<span class="icons">
							<span class="first-icon fui-checkbox-unchecked"></span>
							<span class="second-icon fui-checkbox-checked"></span>
						</span>
						<input type="checkbox" class="login-remberPass" name="remberPass" style="display: none;" data-toggle="checkbox"/>
					</label> 
					<a href="#" class="fr">注册账户</a>
					<span class="fr" style="margin: 0px 5px 7px 5px; vertical-align: middle;">|</span>
	...
	<script type="text/javascript">
		...
		function changeImg(){
			var url = "<%=path%>/verCode?date=" + new Date();
			$("#ver_code").attr("src",url);
